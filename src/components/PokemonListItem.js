...
class PokemonListItem extends Component {
  ...
  handleThrowPokeball = () => {
    ...
    this.props.actions.catchPokemon(this.props.name,this.props.url): swal("Oops", "Hey trainer!, remember you only have 6 pokeballs", "error");
        ...
        <li className="BadgesListItem">
          ...
          <div>
            ...
            <span className="description">
              <p>
                To get all details of this Pokemon click on details if you want
                to catch it try on save button
              </p>
            </span>
            <div>
              <button
              ...
              <button
                type="button"
                className="btn btn-outline-secondary btn-sm"
                onClick={this.handleThrowPokeball}
              >
                Throw Pokeball
              </button>
            </div>
            <Modal details={details} handleThrowPokeball={this.handleThrowPokeball}/>
          </div>
        </li>
      </div>
    );
